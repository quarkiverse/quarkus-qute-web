...
public class QuteImageProcessor {
    ...
    private static void collectImage(ImageTagSection tag, String templateName, Path templatePath, ImagesBuildItem images,
        ...
        images.registerImageTag(tag.section().getOrigin().getTemplateId(), tag.fileParam(), resolvedImage.id().publicPath(),
    ...
    private static ResolvedSourceImage resolveImage(Predicate<Path> isWhitelist, ImagesBuildItem images, Path resolvedPath,
            String name,
